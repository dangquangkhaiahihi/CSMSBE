...
namespace CSMSBE.Api.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<ActionResult> CreateUser(CreateUserDTO model/*, IFormFile file*/)
        {
                model.ValidateInput();
        ...
        public async Task<ActionResult<ResponseItem<IList<LookupDTO>>>> GetLookUpUser([FromQuery] KeywordDto? keywordDto)
        {
            try
            {
        ...
        public async Task<ActionResult<UserDTO>> UpdateUser(UpdateUserDTO model/*, IFormFile file*/)
        {
            try
            {
                model.ValidateInput();
        ...
        public async Task<IActionResult> AssignRoleToUser(string userId, string roleId)
        {
            try
            {
                ...
                CreateLogHistory(ActionEnum.UPDATE.GetHashCode(), "AssignRole");
                return Ok(new ResponseData() { Content = result });
            }
            catch (Exception ex)
            {
