    ...
    public partial class SeedTypeProject : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Dự án xây dựng", "ADMIN", DateTime.UtcNow, "ADMIN", DateTime.UtcNow, false },
                    { 2, "Dự án đường ống nước", "ADMIN", DateTime.UtcNow, "ADMIN", DateTime.UtcNow, false }
                },
            ...
            migrationBuilder.InsertData(
               ...
               values: new object[,]
               {
                    { 1, "Province 1", "P1", "admin", DateTime.UtcNow, "admin", DateTime.UtcNow, false },
                    { 2, "Province 2", "P2", "admin", DateTime.UtcNow, "admin", DateTime.UtcNow, false },
               });
            migrationBuilder.InsertData(
                schema: "sys",
                table: "District",
                ...
                values: new object[,]
                {
                    { 1, "District 1", "D1", 1, "admin", DateTime.UtcNow, "admin", DateTime.UtcNow, false },
                    { 2, "District 2", "D2", 1, "admin", DateTime.UtcNow, "admin", DateTime.UtcNow, false },
                });
            migrationBuilder.InsertData(
               schema: "sys",
               table: "Commune",
               ...
               values: new object[,]
               {
                    { 1, "Commune 1", "C1", 1, "admin", DateTime.UtcNow, "admin", DateTime.UtcNow, false },
                    { 2, "Commune 2", "C2", 1, "admin", DateTime.UtcNow, "admin", DateTime.UtcNow, false },
               });
